...
def test_predict(ml_model_service: MLModelService) -> None:
    ...
    mock_ml_model.preprocessing_pipeline.transform.return_value.toarray.return_value = [
        [0.1, 0.2]
    ]
    ...
    with (
        patch.object(ml_model_service, "get_ml_model", return_value=mock_ml_model),
        patch.object(
            ml_model_service.response_data_service,
            "add_data",
