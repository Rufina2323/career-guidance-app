...
def test_fail_ml_request(ml_request_service: MLRequestService) -> None:
    ...
    with patch.object(ml_request_service.ml_request_repository, "get_user_id", return_value=user_id) as mock_get_user_id, \
         patch.object(ml_request_service.user_service, "get_user_balance_id", return_value=balance_id) as mock_get_balance_id, \
         patch.object(ml_request_service.ml_request_repository, "get_ml_request_cost", return_value=model_cost) as mock_get_cost, \
