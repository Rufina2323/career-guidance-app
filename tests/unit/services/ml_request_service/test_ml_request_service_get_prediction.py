...
def test_get_prediction(ml_request_service: MLRequestService) -> None:
    ...
    with patch.object(ml_request_service.ml_request_repository, "get_prediction_id", return_value=response_data_id) as mock_get_response_id, \
         patch.object(ml_request_service.response_data_service, "get_data", return_value=response_data) as mock_get_data:
