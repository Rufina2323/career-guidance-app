...
def test_validate_username_exists(user_service: UserService):
    ...
    user_service.person_repository.get_by_username.return_value = User(user_id=uuid4(), username=username, email="a@b.com", password_hash="hash", balance=Balance(amount=100))
