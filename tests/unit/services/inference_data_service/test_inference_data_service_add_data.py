...
def test_add_data(inference_data_service: InferenceDataService) -> None:
    ...
    with patch.object(
        ...
        result = inference_data_service.add_data(inference_data)

        mock_add_data.assert_called_once_with(inference_data)
